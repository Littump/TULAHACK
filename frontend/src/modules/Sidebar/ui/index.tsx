...
const Sidebar = memo(() => {
  return (
    <div className="w-[5vw] overflow-hidden group h-[100vh] transition-all duration-200 hover:w-[18vw] px-4 z-20 flex  items-start justify-center py-3 bg-white fixed top-0 left-0 backdrop-blur-2xl">
